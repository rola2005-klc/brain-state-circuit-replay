(function exposeReplayModes() {
  const modes = {
    ...
    direct: {
      ...
      label: 'Direct Engram',
      shortLabel: 'Direct',
      copy: 'Explores the speculative edge of direct trace access. The UI intentionally highlights EEG limits and ethical risk around this mode.',
    ...
    guided: {
      id: 'guided',
      label: 'Guided Endogenous',
      shortLabel: 'Guided',
      copy: 'Combines cues, attention, narrative, and feedback to guide partial state re-entry. It sits between current cueing and more speculative direct control.',
